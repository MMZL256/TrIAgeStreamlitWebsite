...
if wastePicture_buffer is not None: 
    ...
    if predictedClass in ["JuiceBoxLaterals", "JuiceBoxTops", "MilkBoxes", 
        ...
        st.title(":blue-background[Recyclage]")
        ...
        st.title(":orange-background[Compost]")
        st.write("Type d'objet détecté: " + frPredictedClass)
        ...
        st.title(":green-background[Contenants consignés]")
        st.write("Type d'objet détecté: " + frPredictedClass)
        ...
        st.title(":gray-background[Déchets]")
        st.write("Type d'objet détecté: " + frPredictedClass)
...
with st.expander("Voir votre effet"):
    ...
    st.write(f":blue-background[Émissions de GES évitées (recyclage)] {recycled*24.6:.2f}g CO2-e")
